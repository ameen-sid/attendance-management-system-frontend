    ...
    <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex justify-between items-center border-b border-gray-100 pb-6">
        <div>
          ...
          <p className="text-gray-500 mt-1 text-sm">Update your administrative password to keep the system secure.</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden">
        <div className="p-6 border-b border-gray-50 bg-gray-50/30 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h2 className="font-bold text-gray-800 text-sm uppercase tracking-wider">Change Password</h2>
          </div>
        ...
        <form onSubmit={handleUpdatePassword} className="p-8 space-y-6">
          ...
          <div className="space-y-5">
            <PasswordField
              ...
              show={showPasswords}
              onChange={(v: string) => setPasswords({ ...passwords, currentPassword: v })}
            />
            ...
            <PasswordField
              ...
              show={showPasswords}
              onChange={(v: string) => setPasswords({ ...passwords, newPassword: v })}
            />
            ...
            <PasswordField
              ...
              show={showPasswords}
              onChange={(v: string) => setPasswords({ ...passwords, confirmPassword: v })}
            />
          </div>
      ...
      <div className="p-4 bg-amber-50 rounded-2xl border border-amber-100 flex gap-3 items-start">
        ...
        <p className="text-xs text-amber-800 leading-relaxed font-medium">
          Note: Changing your password will require you to log back in on all devices to verify your identity.
        </p>
      </div>
    </div>
  );
...
const PasswordField = ({ label, value, onChange, show }: any) => (
